...
namespace z8l_intranet_be.Application.User
{
    ...
    public class AuthController : Controller
    {
        ...
        public IActionResult Login([FromBody] AuthPresenter model)
        {
            ...
            UserPresenter user = authService.Login(model.Username, model.Password);
        ...
        public IActionResult GetCurrentUser()
        {
            ...
            UserPresenter user = userService.GetOne(id);
            if (user == null)
            {
                throw new UnauthorizedException();
            }
        ...
        public IActionResult RefreshToken(RefreshTokenPresenter request)
        {
            ...
            UserPresenter user = userService.GetOne(userId);
